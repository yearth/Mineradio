...
- Worktree: server shell finalization is in progress; latest verified slice extracts QQ route adapter wiring into `server/composition/qq-route-adapters.ts`.
