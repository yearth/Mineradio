...
- Worktree: server shell finalization is in progress; latest verified local slice extracts Netease route adapter wiring into `server/composition/netease-route-adapters.ts`.
